...
/**
 * \file    core/triggers/interface_99_modMyDATA_MyDATATriggers.class.php
 * \ingroup mydata
 ...
 *      - interface_99_modMyDATA_MyTrigger.class.php
...
/**
 *  Class of triggers for MyDATA module
 */
class InterfaceMyDATATriggers extends DolibarrTriggers
{
	/**
	 * Constructor
	 *
	...
	public function __construct($db)
	{
		...
		$this->family = "demo";
		$this->description = "MyDATA triggers.";
		// 'development', 'experimental', 'dolibarr' or version
		$this->version = 'development';
		$this->picto = 'mydata@mydata';
	}
	...
	public function runTrigger($action, $object, User $user, Translate $langs, Conf $conf)
	{
        ...
        if ($object->type == Facture::TYPE_STANDARD) {
            ...
            if (in_array($selectedcode, array('1.1', '1.2', '1.3', '1.4', '1.5', '1.6'))) {
                ...
                $sql1 = "UPDATE ".MAIN_DB_PREFIX."facture INNER JOIN ".MAIN_DB_PREFIX."facture_extrafields ON ".MAIN_DB_PREFIX."facture.rowid = ".MAIN_DB_PREFIX."facture_extrafields.fk_object set mydata_type ='0' ORDER BY ".MAIN_DB_PREFIX."facture.rowid DESC LIMIT 1";	
                ...
                $sql1 = "UPDATE ".MAIN_DB_PREFIX."facture INNER JOIN ".MAIN_DB_PREFIX."facture_extrafields ON ".MAIN_DB_PREFIX."facture.rowid = ".MAIN_DB_PREFIX."facture_extrafields.fk_object set mydata_type ='1' ORDER BY ".MAIN_DB_PREFIX."facture.rowid DESC LIMIT 1";	
                ...
                $sql1 = "UPDATE ".MAIN_DB_PREFIX."facture INNER JOIN ".MAIN_DB_PREFIX."facture_extrafields ON ".MAIN_DB_PREFIX."facture.rowid = ".MAIN_DB_PREFIX."facture_extrafields.fk_object set mydata_type ='2' ORDER BY ".MAIN_DB_PREFIX."facture.rowid DESC LIMIT 1";	
                ...
                $sql1 = "UPDATE ".MAIN_DB_PREFIX."facture INNER JOIN ".MAIN_DB_PREFIX."facture_extrafields ON ".MAIN_DB_PREFIX."facture.rowid = ".MAIN_DB_PREFIX."facture_extrafields.fk_object set mydata_type ='3' ORDER BY ".MAIN_DB_PREFIX."facture.rowid DESC LIMIT 1";	
            ...
            if (in_array($selectedcode, array('5.2'))) {
                $sql1 = "UPDATE ".MAIN_DB_PREFIX."facture INNER JOIN ".MAIN_DB_PREFIX."facture_extrafields ON ".MAIN_DB_PREFIX."facture.rowid = ".MAIN_DB_PREFIX."facture_extrafields.fk_object set mydata_type ='4' ORDER BY ".MAIN_DB_PREFIX."facture.rowid DESC LIMIT 1";	
                ...
                $sql1 = "UPDATE ".MAIN_DB_PREFIX."facture INNER JOIN ".MAIN_DB_PREFIX."facture_extrafields ON ".MAIN_DB_PREFIX."facture.rowid = ".MAIN_DB_PREFIX."facture_extrafields.fk_object set mydata_type ='5' ORDER BY ".MAIN_DB_PREFIX."facture.rowid DESC LIMIT 1";	
